...
import 'package:version1_0/services/httpService_themeForum.dart';
...
class ThemeForum extends StatefulWidget {
  final ThemeModel theme;

  ThemeForum({required this.theme});
  @override
  _ThemeForumState createState() => _ThemeForumState();
}

class _ThemeForumState extends State<ThemeForum> {
  final HttpServiceThemeForum httpService = HttpServiceThemeForum();
  final HttpServiceCreateThemeForumPost httpServicePost =
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: SlidingUpPanel(
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                ElevatedButton(
                  onPressed: () async {
                    ThemeMessage newThemeMessage = new ThemeMessage(
                    ...
                    if (formGlobalKey.currentState!.validate()) {
                      httpServicePost.createThemeForumPost(
                          body: newThemeMessage.toMap());
        ...
        ///////////////////////////////
        body: FutureBuilder(
          future: httpService.getThemeForum(widget.theme.themeID),
          builder: (BuildContext context,
              AsyncSnapshot<List<ThemeMessage>> snapshot) {
            if (globalEventId == 0) {
            ...
            return ThemesNotAdded();
              ...
              List<ThemeMessage>? messages = snapshot.data;
              return Container(
                //height: 300,
                child: ListView(
                  children: messages!
                      .map(
                        (ThemeMessage message) => Card(
