...
class _AllScheduleViewState extends State<AllScheduleView> {
  ...
  Widget build(BuildContext context) {
    return Consumer<ScheduleNotifier>(builder: (BuildContext context,
        ScheduleNotifier scheduleNotifier, Widget? child) {
      switch (scheduleNotifier.scheduleListState) {
        case ScheduleListState.SUCCESS:
          return Column(
            children: [
              for (var schedule in scheduleNotifier.scheduleList.scheduleList)
        ...
        case ScheduleListState.ERROR:
          return Text('ERROR Malfunction Detected!');
        default:
