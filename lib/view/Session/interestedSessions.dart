...
class InterestedSessions extends StatelessWidget {
  final HttpServiceInterestedSession httpService =
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        future: httpService.getInterestedSessions(userID), //make userID dynamic
