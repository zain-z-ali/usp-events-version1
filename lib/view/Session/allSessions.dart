...
import 'package:version1_0/view/Session/sessionDetailsHome.dart';
...
class AllSessions extends StatelessWidget {
  final HttpServiceSession httpService = HttpServiceSession();
  //final HttpServiceInterestedSession httpService = HttpServiceInterestedSession();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
        ...
        //future: httpService.getInterestedSessions(1),
